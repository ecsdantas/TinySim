...
class ModModel extends VariadicMathModel {
    ...
    modalTitle = 'Mod Block'
    helpText = <>This block calculates the remainder of the first input value divided by all subsequent input values.<br />You can add new ports.</>
